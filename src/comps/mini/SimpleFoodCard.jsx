...
export default function SimpleFoodCard({
  ...
  return (
    <div className="relative w-[154px] h-60 bg-white rounded-2xl shadow-sm border border-slate-200 p-4 py-5 flex flex-col justify-between overflow-hidden">
      ...
      <h3
        className={`text-center font-medium mt-2 w-full h-10 flex justify-center items-center ${
          name.length > 14 ? "text-sm" : "text-lg"
        } line-clamp-2`}
      >
        {name}
      </h3>
